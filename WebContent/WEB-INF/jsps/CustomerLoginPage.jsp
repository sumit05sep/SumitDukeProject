...
<link type="text/css" href="../csss/style.css" rel="stylesheet"></link>
...
<body>
	...
	<div class="container">
		...
		<form action="authentication" method="post">
			...
			<div>
				<input type="submit" value="Log in" /> <a href="newCustomer">Register</a>
			</div>
		</form>
		<!-- form --> </section>
		<!-- content -->
...
<div class="container contact">
	...
	<a>email@mail.com</a>
	<address>
		123 Street<br /> Anywhere, USA</br> 1.800.555.6666
	</address>
</div>

<div class="container cta">
	<h4>
		Want more info?</br> Click below!
	</h4>
